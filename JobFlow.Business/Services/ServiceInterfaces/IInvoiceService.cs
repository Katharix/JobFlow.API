...
public interface IInvoiceService
{
    ...
    Task<Result<Invoice>> UpdateInvoiceAsync(Guid id, Guid organizationId, DateTime? invoiceDate, DateTime dueDate, List<InvoiceLineItem> lineItems, string? notes = null);
