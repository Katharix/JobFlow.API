...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobFlow.Domain.Models.EmployeeRoleAssignment", b =>
                {
                    b.Property<Guid>("EmployeeId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("EmployeeRoleAssignments", (string)null);
                });
            ...
            modelBuilder.Entity("JobFlow.Domain.Models.EstimateSequence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("EstimateSequence", (string)null);
                });
            ...
            modelBuilder.Entity("JobFlow.Domain.Models.Organization", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("FirstRealEstimateSentAt")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<DateTimeOffset?>("PaymentSetupSkippedAt")
                        .HasColumnType("datetimeoffset");

                    b.Property<string>("PhoneNumber")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTimeOffset?>("ReferralCtaShownAt")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("JobFlow.Domain.Models.OrganizationClient", b =>
                {
                    ...
                    b.Property<bool>("SmsConsentGiven")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("JobFlow.Domain.Models.OrganizationOnboardingEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("OrganizationId", "StepName", "EventType");

                    b.ToTable("OrganizationOnboardingEvents", (string)null);
                });
            ...
            modelBuilder.Entity("JobFlow.Domain.Models.QuickBooksConnection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JobFlow.Domain.Models.SetupCompanionEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SetupCompanionEvents");
                });
            ...
            modelBuilder.Entity("JobFlow.Domain.Models.SupportChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SupportChatMessage", "support");
                });

            modelBuilder.Entity("JobFlow.Domain.Models.SupportChatSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("EstimatedWaitSeconds")
                        .HasColumnType("int");
                    ...
                    b.ToTable("SupportChatSession", "support");
                });
            ...
            modelBuilder.Entity("JobFlow.Domain.Models.SupportChatMessage", b =>
                {
                    b.HasOne("JobFlow.Domain.Models.SupportChatSession", "Session")
                        .WithMany("Messages")
