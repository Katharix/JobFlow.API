    ...
    internal class JobStatusConfiguration : IEntityTypeConfiguration<JobStatus>
    {
        ...
        private JobStatus[] PopulateJobStatusData()
        {
            return
                ...
                new JobStatus{  Id = Guid.Parse("be7d4999-e30f-4d4a-8f8b-580344e14dcd"),Status = "Failed"},
                new JobStatus{  Id = Guid.Parse("1ca909ea-e3e8-4364-a81f-7c5b93d9bc25"),Status = "Awaiting Approval"},
                ];
        }
    }
}
